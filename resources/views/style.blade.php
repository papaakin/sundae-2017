...
<head>
	<meta charset="UTF-8">
	<title>Style</title>
	<!-- <link rel="stylesheet" type="text/css" href="bootstrap/scss/bootstrap.scss"> -->
        ...
        <div class="col-sm-12">
            <div class="card" style="margin: 30px 0px;">
                ...
                <div class="card-block">
                    ...
                    <button class="btn btn-primary btn-lg">NEXT</button> <br><br>
                    <code>&lt;button class="btn btn-secondary"/&gt;</code> <br><br>
                    <button class="btn btn-secondary">NEXT</button> <br><br>
                    <code>&lt;button class="btn btn-icon-only btn-primary"/&gt;</code> <br><br>
                    <button class="btn btn-secondary btn-icon-only btn-sm"><i class="icon-search"></i></button>
                    <button class="btn btn-secondary btn-icon-only"><i class="icon-search"></i></button>
                    <button class="btn btn-secondary btn-icon-only btn-lg"><i class="icon-search"></i></button>
